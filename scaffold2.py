...
alpha_kd        = 1.0
beta_ewc        = 100.0
mu              = 0.1   # FedProx coefficient (used in prox term)
            ...
            for cid, idxs in enumerate(client_idxs):
                ...
                for _ in range(local_epochs):
                    for x,y in loader:
                        ...
                        elif method=='lwf': loss += lwf_loss(local, st['old_model'], x)
                        elif method=='si':  loss += si_loss(local, st['si_state'])
